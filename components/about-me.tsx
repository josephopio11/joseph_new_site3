    ...
    <section id="about" className="container mx-auto px-4 py-20">
      ...
      <div className="grid items-start gap-12 md:grid-cols-5">
        <div className="relative md:col-span-2">
          <div className="aspect-video overflow-hidden rounded-3xl bg-gradient-to-br from-purple-300 to-pink-300 shadow-xl shadow-purple-950/50 md:aspect-[3/7] lg:aspect-[3/5]">
            <img
        ...
        <div className="md:col-span-3">
          <div className="columns-1 sm:columns-2">
            <p className="text-muted-foreground mb-4 text-xs leading-relaxed xl:text-base">
          ...
          <Card className="from-primary/70 my-8 border-0 bg-gradient-to-r to-purple-600/80 dark:from-black dark:shadow-lg dark:shadow-white/20">
            <CardContent className="p-6">
              <p className="leading-relaxed text-white italic">
                ...
                opportunities. Let&apos;s explore the limitless possibilities
                that technology offers together!
              </p>
            </CardContent>
          </Card>
