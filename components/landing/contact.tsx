...
const Contact = () => {
  return (
    <section id="contact" className="container mx-auto scroll-mt-28 px-4 pb-20">
      <h2 className="mb-12 text-4xl font-bold md:text-5xl">Contact</h2>
      <div className="grid gap-8 md:grid-cols-5">
        <Card className="from-primary/80 border-0 bg-gradient-to-br to-purple-600/80 md:col-span-2 dark:border dark:border-white/30 dark:from-black dark:shadow-lg dark:shadow-white/20">
          <CardContent className="space-y-6 p-8">
            ...
            <div>
              <div className="grid-md-1 grid gap-4 sm:grid-cols-2 md:grid-cols-2">
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800">
                  <div className="flex flex-row gap-2">
                    <p className="m-0 justify-center p-0 align-middle text-3xl dark:text-slate-200">
                      <FaRegEnvelope />
                    </p>
