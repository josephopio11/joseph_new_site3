...
- **Core Requirements (The "Bronze" Level):**
  ...
  - _This level focuses on basic variables, `if/elif/else` statements, and `while` loops._
...
- **Extension Goals (The "Silver" Level):**
  ...
  - _This level introduces lists/arrays and more complex nested logic._
...
- **Advanced Challenges (The "Gold" Level):**
  ...
  - _This level pushes students into data structures, file I/O, and even object-oriented concepts._
